    ...
    try:
        ...
        if target_column:
            ...
            if selected_model == 'Logistic Regression':
                ...
                # Gaussian Naive Bayes expects non-negative values for some applications. Scaling can result in negative values.
                # For robustness, we might consider not scaling for NB or using a different scaler, but for now, we proceed.
            ...
            if results:
                ...
                st.warning("Please select a model to see evaluation results.")
